      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8 mb-8">
        ...
        <div className="lg:w-1/2">
          ...
          <p className="text-sm sm:text-base text-gray-700">
            ...
            businesses, and organizations to succeed in the pharmaceutical industry.
          </p>
        </div>
        ...
        {events.map((event, idx) => (
          <div key={idx} className="keen-slider__slide rounded-2xl overflow-hidden relative">
            ...
            <div className="absolute inset-0 bg-black/40 p-4 text-white flex flex-col justify-between">
              ...
              <button className="bg-white/20 px-4 py-2 text-sm rounded-2xl   w-[150px] items-center gap-1 cursor-pointer">
                📷 View Gallery
              </button>
            </div>
          </div>
